...
Stations : 69028 (PILFs = 5), 71011 (PILFs = 2), 52011 (PILFs = 2), 50014 (PILFs = 5), 10001 (PILFs = 2)
...
ggsave(plot = legend,
       filename = "C:/Users/Nathan Huet/robust_gev/final_final_plots/real/final_figs/legend_return_curve.png",
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")

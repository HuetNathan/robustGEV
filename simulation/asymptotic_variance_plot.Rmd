...
```{r}
#save(plot_data_xi,file=paste0("/simulation/new_generated_datasets/df_asymptotic_variance_xi.RData"))

load(file=paste0("/simulation/generated_datasets/df_asymptotic_variance_xi.RData"))
...
ggsave(plot = plot_asymptotic_variance_xi,
       filename = paste0("/simulation/figures/asymptotic_variance_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
#save(plot_data,file=paste0("/simulation/new_generated_datasets/df_asymptotic_variance_sigma.RData"))

load(file="/simulation/generated_datasets/df_asymptotic_variance_sigma.RData")
...
ggsave(plot = plot_asymptotic_variance_sigma,
       filename = paste0("/simulation/figures/asymptotic_variance_sigma.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
#save(plot_data,file=paste0("/simulation/generated_datasets/df_asymptotic_variance_sigma.RData"))

load(file="/simulation/generated_datasets/df_asymptotic_variance_mu.RData")
...
ggsave(plot = plot_asymptotic_variance_mu,
       filename = paste0("/simulation/figures/asymptotic_variance_mu.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")

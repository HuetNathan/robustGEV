...
source("C:/Users/huetn/Documents/github_repos/robustGEV/functions/influence_function.R")
...
```{r}
ggsave(plot = plot_if,
       filename = paste0("C:/Users/huetn/Documents/github_repos/robustGEV/simulation/new_figures/IF_mu_positive_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
ggsave(plot = plot_if,
       filename = paste0("C:/Users/huetn/Documents/github_repos/robustGEV/simulation/new_figures/IF_sig_positive_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
ggsave(plot = plot_if,
       filename = paste0("C:/Users/huetn/Documents/github_repos/robustGEV/simulation/new_figures/IF_xi_positive_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
ggsave(plot = plot_if,
       filename = paste0("C:/Users/huetn/Documents/github_repos/robustGEV/simulation/new_figures/IF_mu_negative_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")
...
```{r}
ggsave(plot = plot_if,
       filename = paste0("C:/Users/huetn/Documents/github_repos/robustGEV/simulation/new_figures/IF_sig_negative_xi.png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,
       units = "in")

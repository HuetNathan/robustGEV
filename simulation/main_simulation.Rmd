...
for (xi1 in xi1_varying){
  for (sig1 in sig1_varying){
    ...
    MLE_mse_list <- (estimates_mle - c(mu0,sig0,xi0))^2
    MLE_mse <- rowMeans(MLE_mse_list)
    MLE_se <- apply(MLE_mse_list, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    wd_ext_mle_list <- lapply(seq(sum(mle_is_successful)), function(i) wasserstein_for_gev(c(mu0,sig0,xi0),estimates_mle[,i],p,0.7))
    wd_ext_mle <- mean(unlist(wd_ext_mle_list))
    wd_ext_mle_se <- sd(unlist(wd_ext_mle_list))/sqrt(length(wd_ext_mle_list))
    ...
    MDPDE_mse_list_005 <- (estimates_mdpde_005 - c(mu0,sig0,xi0))^2
    MDPDE_mse_005 <- rowMeans(MDPDE_mse_list_005)
    MDPDE_se_005 <- apply(MDPDE_mse_list_005, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    wd_ext_mdpde_list_005 <- lapply(seq(sum(mdpde_005_is_successful)), function(i) wasserstein_for_gev(c(mu0,sig0,xi0),estimates_mdpde_005[,i],p,0.7))
    wd_ext_mdpde_005 <- mean(unlist(wd_ext_mdpde_list_005))
    wd_ext_mdpde_005_se <- sd(unlist(wd_ext_mdpde_list_005))/sqrt(length(wd_ext_mdpde_list_005))
    ...
    MDPDE_mse_list_01 <- (estimates_mdpde_01 - c(mu0,sig0,xi0))^2
    MDPDE_mse_01 <- rowMeans(MDPDE_mse_list_01)
    MDPDE_se_01 <- apply(MDPDE_mse_list_01, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    wd_ext_mdpde_list_01 <- lapply(seq(sum(mdpde_01_is_successful)), function(i) wasserstein_for_gev(c(mu0,sig0,xi0),estimates_mdpde_01[,i],p,0.7))
    wd_ext_mdpde_01 <- mean(unlist(wd_ext_mdpde_list_01))
    wd_ext_mdpde_01_se <- sd(unlist(wd_ext_mdpde_list_01))/sqrt(length(wd_ext_mdpde_list_01))
    ...
    MQ_mse_list <- (estimates_mq - c(mu0,sig0,xi0))^2
    MQ_mse <- rowMeans(MQ_mse_list)
    MQ_se <- apply(MQ_mse_list, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    wd_ext_mq_list <- lapply(seq(sum(mq_is_successful)), function(i) wasserstein_for_gev(c(mu0,sig0,xi0),estimates_mq[,i],p,0.7))
    wd_ext_mq <- mean(unlist(wd_ext_mq_list))
    wd_ext_mq_se <- sd(unlist(wd_ext_mq_list))/sqrt(length(wd_ext_mq_list))
    ...
    OMSE_mse_list <- (estimates_OMSE - c(mu0,sig0,xi0))^2
    OMSE_mse <- rowMeans(OMSE_mse_list)
    OMSE_se <- apply(OMSE_mse_list, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    RMXE_mse_list <- (estimates_RMXE - c(mu0,sig0,xi0))^2
    RMXE_mse <- rowMeans(RMXE_mse_list)
    RMXE_se <- apply(RMXE_mse_list, 1, function(x) sd(x)/sqrt(length(x)))
    ...
    new_row_param <- data.frame(
      ...
      MLE_mu_mse = signif(MLE_mse[[1]],digits = 3),
      MLE_mu_se = signif(MLE_se[[1]],digits = 2),
      MLE_sig_mse = signif(MLE_mse[[2]],digits = 3),
      MLE_sig_se = signif(MLE_se[[2]],digits = 2),
      MLE_xi_mse = signif(MLE_mse[[3]],digits = 3),
      MLE_xi_se = signif(MLE_se[[3]],digits = 2),
      
      MDPDE_mu_mse_005 = signif(MDPDE_mse_005[[1]],digits = 3),
      MDPDE_mu_se_005 = signif(MDPDE_mse_005[[1]],digits = 2),
      MDPDE_sig_mse_005 = signif(MDPDE_mse_005[[2]],digits = 3),
      MDPDE_sig_se_005 = signif(MDPDE_se_005[[2]],digits = 2),
      MDPDE_xi_mse_005 = signif(MDPDE_mse_005[[3]],digits = 3),
      MDPDE_xi_se_005 = signif(MDPDE_se_005[[3]],digits = 2),
      
      MDPDE_mu_mse_01 = signif(MDPDE_mse_01[[1]],digits = 3),
      MDPDE_mu_se_01 = signif(MDPDE_mse_01[[1]],digits = 2),
      MDPDE_sig_mse_01 = signif(MDPDE_mse_01[[2]],digits = 3),
      MDPDE_sig_se_01 = signif(MDPDE_se_01[[2]],digits = 2),
      MDPDE_xi_mse_01 = signif(MDPDE_mse_01[[3]],digits = 3),
      MDPDE_xi_se_01 = signif(MDPDE_se_01[[3]],digits = 2),
      
      MQ_mu_mse = signif(MQ_mse[[1]],digits = 3),
      MQ_mu_se = signif(MQ_se[[1]],digits = 2),
      MQ_sig_mse = signif(MQ_mse[[2]],digits = 3),
      MQ_sig_se = signif(MQ_se[[2]],digits = 2),
      MQ_xi_mse = signif(MQ_mse[[3]],digits = 3),
      MQ_xi_se = signif(MQ_se[[3]],digits = 2),
      
      OMSE_mu_mse = signif(OMSE_mse[[1]],digits = 3),
      OMSE_mu_se = signif(OMSE_se[[1]],digits = 2),
      OMSE_sig_mse = signif(OMSE_mse[[2]],digits = 3),
      OMSE_sig_se = signif(OMSE_se[[2]],digits = 2),
      OMSE_xi_mse = signif(OMSE_mse[[3]],digits = 3),
      OMSE_xi_se = signif(OMSE_se[[3]],digits = 2),
      
      RMXE_mu_mse = signif(RMXE_mse[[1]],digits = 3),
      RMXE_mu_se = signif(RMXE_se[[1]],digits = 2),
      RMXE_sig_mse = signif(RMXE_mse[[2]],digits = 3),
      RMXE_sig_se = signif(RMXE_se[[2]],digits = 2),
      RMXE_xi_mse = signif(RMXE_mse[[3]],digits = 3),
      RMXE_xi_se = signif(RMXE_se[[3]],digits = 2),
      
      stringsAsFactors = FALSE
    )
    
    df_param <- rbind(df_param, new_row_param)
...
save(df_param,file=paste0("C:/Users/Nathan Huet/robust_gev/final_final_plots/simulation/datasets/df_param_n", df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_wd,file=paste0("C:/Users/Nathan Huet/robust_gev/final_final_plots/simulation/datasets/df_wd_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_missing_value,file=paste0("C:/Users/Nathan Huet/robust_gev/final_final_plots/simulation/datasets/df_missing_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))
```
...
save(df_param,file=paste0("generated_datasets/df_param_n", df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_wd,file=paste0("generated_datasets/df_wd_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_missing_value,file=paste0("generated_datasets/df_missing_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))
```
...
#load("generated_datasets/datasets/df_wd_n100_sign_xi1_varying_xi_eps10.RData")

df_mse <-  data.frame(
  x = as.numeric(rep(df_wd$xi1, 6)),
  y = c(df_wd$wd_mle, df_wd$wd_mdpde_005, df_wd$wd_mdpde_01,df_wd$wd_mq,df_wd$wd_OMSE,df_wd$wd_RMXE),
  group = rep(c("MLE", "MDPDE005", "MDPDE01","MQE","OMSE","RMXE"), each = length(df_wd$wd_mle))
)

df_ci <- data.frame(
  x = rep(df_wd$xi1, 6),
  y = c(df_wd$wd_mle_se, df_wd$wd_mdpde_005_se, df_wd$wd_mdpde_01_se,df_wd$wd_mq_se,df_wd$wd_OMSE_se,df_wd$wd_RMXE_se),
  group = rep(c("MLE", "MDPDE005", "MDPDE01","MQE","OMSE","RMXE"), each = length(df_wd$wd_mle))
)

df_plot <- df_mse
df_plot$group <- factor(df_plot$group,
                        levels = c("MLE", "MDPDE005", "MDPDE01",
                                   "MQE", "OMSE", "RMXE"))
df_plot$se <- df_ci$y
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  labs(x = TeX("$\\xi_1$"), y = "MSE", color = "Models")+
  scale_x_continuous(
    breaks = c(-2,-1.5,-1, -0.5, 0, 0.3, 1,1.5,2),
    labels = c("-2","-1.5","-1","-0.3","0","0.3","1","1.5","2")
  )+
  annotate("text", x = df_wd$xi0 + 0.1, y = 3*df_wd$wd_mq[15],
  ...
  scale_colour_viridis_d(option = "turbo",
     ...
     breaks=c("MLE","MDPDE005","MDPDE01","MQE","OMSE","RMXE"),
     name = "Models")+
...
```{r}
ggsave(plot = plt,
       filename = paste0("figures/supp_plot_n",
...
#load("generated_datasets/datasets/df_wd_n100_sign_xi1_varying_sig_eps10.RData")
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  labs(x = TeX("$\\sigma_1$"), y = "MSE", color = "Models")+
  annotate("text", x = df_wd$sig0 - 0.1, y = 1.3*df_wd$wd_mq[10],
...
#load("C:/Users/Nathan Huet/robust_gev/final_final_plots/simulation/datasets/df_wd_n100_sign_xi0_varying_xi_eps02.RData")


df_mse <-  data.frame(
  x = as.numeric(rep(df_wd$xi1, 4)),
  y = c(df_wd$wd_mle, df_wd$wd_mdpde_005, df_wd$wd_mdpde_01,df_wd$wd_mq),
  group = rep(c("MLE", "MDPDE005", "MDPDE01","MQE"), each = length(df_wd$wd_mle))
)

df_ci <- data.frame(
  x = rep(df_wd$xi1, 4),
  y = c(df_wd$wd_mle_se, df_wd$wd_mdpde_005_se, df_wd$wd_mdpde_01_se,df_wd$wd_mq_se),
  group = rep(c("MLE", "MDPDE005", "MDPDE01","MQE"), each = length(df_wd$wd_mle))
)
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  scale_color_manual(
      ...
      breaks=c("MLE","MDPDE005","MDPDE01","MQE"),
      name = "Models"
    )+
  theme(#legend.position = "none",
    legend.position =c(.2, .75),
...
#load("C:/Users/Nathan Huet/robust_gev/final_final_plots/simulation/datasets/df_wd_n100_sign_xi0_varying_sig_eps02.RData")
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  geom_vline(xintercept = df_wd$sig0, linetype = "dashed", color = "grey24") +
  labs(x = TeX("$\\sigma_1$"), y = "MSE", color = "Models")+
  annotate("text", x = df_wd$sig0 - 0.1, y = 2*df_wd$wd_mq[10],
           label = TeX("$\\sigma_0$"), color = 'grey24',size=6)+
  theme_minimal() +
  scale_color_manual(
      values = c("MLE" = "#31123b",
...
```{r}
ggsave(plot = plt,
       filename = paste0("datasets/supp_plot_n",
                         df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_sig_eps", df_wd$eps[1]*100,".png"),
       width = 1760 / 180,
       height = 1060 / 180,
       dpi = 180,

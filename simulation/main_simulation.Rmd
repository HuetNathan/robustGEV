...
```{r}
save(df_wd,file=paste0("/simulation/generated_datasets/supp_df_wd_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_missing_value,file=paste0("/simulation/generated_datasets/supp_df_missing_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))
```
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  annotate("text", x = df_wd$xi0 + 0.1, y = 1.1*df_wd$wd_mq[15],
...
```{r}
ggsave(plot = plt,
       filename = paste0("/simulation/figures/supp_plot_n",
...
#load("/simulation/generated_datasets/df_wd_n100_sign_xi1_varying_sig_eps20.RData")
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  annotate("text", x = df_wd$sig0 - 0.1, y = 1.1*df_wd$wd_mq[5],
...
save(df_wd,file=paste0("/simulation/generated_datasets/df_wd_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))

save(df_missing_value,file=paste0("/simulation/generated_datasets/df_missing_n",df_wd$n[1],"_sign_xi",sign(df_wd$xi0[1]) ,"_varying_xi_eps", df_wd$eps[1]*100,".RData"))
```
...
#load("/simulation/generated_datasets/df_wd_n100_sign_xi1_varying_xi_eps10.RData")
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  annotate("text", x = df_wd$xi0 + 0.1, y = 1.2*df_wd$wd_mq[15],
           label = TeX("$\\xi_0$"), color = 'grey24',size=6)+
  theme_minimal() +
  scale_color_manual(
      values = c("MLE" = "#31123b",
...
plt <- ggplot(df_plot, aes(x = x, y = y, color = group, shape = group)) +
  ...
  annotate("text", x = df_wd$sig0 - 0.1, y = 1.5*df_wd$wd_mq[5],
           label = TeX("$\\sigma_0$"), color = 'grey24',size=6)+
  theme_minimal()+
  scale_x_continuous(
    breaks = c(0.5, 1,2,3),
